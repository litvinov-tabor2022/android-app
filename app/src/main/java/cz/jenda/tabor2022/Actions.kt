...
object Actions {
    const val ACTION_TAG_READ = "cz.jenda.tabor2022.action.TAG_READ"
    const val ACTION_TAG_READ_ERROR = "cz.jenda.tabor2022.action.TAG_READ_ERROR"
    const val ACTION_DATA_WRITTEN_ON_TAG = "cz.jenda.tabor2022.action.ACTION_DATA_WRITTEN_ON_TAG"
}

object Extras {
    const val DATA_TO_WRITE_ON_TAG = "cz.jenda.tabor2022.extra.DATA_TO_WRITE_ON_TAG"
    const val REFERENCE_DATA = "cz.jenda.tabor2022.extra.REFERENCE_DATA"
